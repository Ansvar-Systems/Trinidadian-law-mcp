...
const LIST_SOURCES_TOOL: Tool = {
  ...
  description:
    ...
    'Call this FIRST when you need to understand what Trinidad and Tobago legal data this server covers.',
  inputSchema: { type: 'object', properties: {} },
};
...
export const TOOLS: Tool[] = [
  {
    ...
    description:
      'Search Trinidad and Tobago statutes and regulations by keyword using full-text search (FTS5 with BM25 ranking). ' +
  ...
  },
  {
    name: 'get_provision',
    description:
      'Retrieve the full text of a specific provision (section) from a Trinidad and Tobago statute. ' +
    ...
    inputSchema: {
      ...
      properties: {
        ...
        section: {
          type: 'string',
          description: 'Section number. Omit to get all provisions.',
        },
        provision_ref: {
          type: 'string',
  ...
  },
  {
    ...
    description:
      'Validate a Trinidad and Tobago legal citation against the database -- zero-hallucination check. ' +
  ...
  },
  {
    ...
    description:
      'Build a comprehensive set of citations for a legal question by searching across all Trinidad and Tobago statutes simultaneously. ' +
  ...
  },
  {
    ...
    description:
      'Format a Trinidad and Tobago legal citation per standard conventions. ' +
  ...
  },
  {
    name: 'check_currency',
    description:
      'Check whether a Trinidad and Tobago statute or provision is currently in force, amended, or repealed. ' +
