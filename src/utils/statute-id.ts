/**
 * Statute ID resolution for Trinidad and Tobago Law MCP.
 *
 ...
 * Supports:
 * - Direct ID match (e.g., "tt-data-protection-act")
 * - Act title match (e.g., "Data Protection Act")
 * - Partial title match (e.g., "Data Protection", "Cybercrime")
 * - Short name match (e.g., "Chapter 22:04")
 */
