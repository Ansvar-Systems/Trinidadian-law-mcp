...
This document addresses privacy and confidentiality considerations when using this Tool, with particular attention to professional obligations under Belizean legal professional rules.
...
- Law Society of Belize rules require strict confidentiality and data handling controls

**Safe Use Options:**
1. **General Legal Research**: Use Tool for non-client-specific queries
2. **Local npm Package**: Install `@ansvar/belizean republic-law-mcp` locally — database queries stay on your machine
...
```bash
npx @ansvar/belizean republic-law-mcp
```
...
```
Endpoint: https://belizean republic-law-mcp.vercel.app/mcp
```
...
## Professional Obligations (Belize)

### Law Society of Belize and Advocates Act

Belizean lawyers (advocates) are bound by strict confidentiality rules under the Advocates Act (Cap 16) and the Law Society of Belize Code of Standards of Professional Practice and Ethical Conduct.
...
3. Client matters: Use commercial legal databases (Belize Law Reports, LexisNexis East Africa)
...
2. Follow Belizean government information security requirements
...
- **Privacy Questions**: Open issue on [GitHub](https://github.com/Ansvar-Systems/belizean republic-law-mcp/issues)
- **Anthropic Privacy**: Contact privacy@anthropic.com
- **LSK Guidance**: Consult Law Society of Belize ethics guidance
